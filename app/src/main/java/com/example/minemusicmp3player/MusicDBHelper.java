...
public class MusicDBHelper extends SQLiteOpenHelper {
    ...
    // sdCard 안의 가수, 음악을 검색한다                   매개변수
    public ArrayList<MusicData> findMusicSinger(String serch) {
...
//        String selectionArqs = new String[]{"%MusicList%"}
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                //비교해서 맞으면 sd카드에서 가수, 음악 찾아옴 (스페이바 띄고 검색해도 잘 나옴)
                if (artist.contains(serch) == true || title.contains(serch) == true){
